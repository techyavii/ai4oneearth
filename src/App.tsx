...
import ChallengeRequirementsPage from "./pages/ChallengeRequirementsPage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/evaluation-process" element={<EvaluationProcessPage />} />
          <Route path="/challenge-requirements" element={<ChallengeRequirementsPage />} />
